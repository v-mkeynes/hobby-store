...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (check.equals("settings"))
        {
            ...
            titleQuestions.setText("Please set your answer to the following security questions");
        ...
        else
        {
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Toast.makeText(ResetPasswordActivity.this, "Your answers have been logged successfully", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    private void verifyUser()
    {
        ...
        if (!phone.equals("") && !answer1.equals("") && !answer1.equals(""))
